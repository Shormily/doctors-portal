...
const FAQ = () => {
    return (
        ...
        <p className="pt-32 text-2xl text-center text-white ">Appoinment</p>
        <div
          style={{
      ...
      <div className=" max-w-[1440px]  m-auto mt-24 gap-12 flex justify-center item-center grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 ">
        ...
        <div>
          <BsFillLayersFill className="text-blue-900" size={70} />
          <p className="text-3xl mt-7 ">Refractive surgery</p>
          <p className="text-[12px] mt-8">
        ...
        <div>
          <BsFillSignpost2Fill className="text-blue-900" size={80} />
          <p className="text-3xl mt-5 ">Cornea</p>
          <p className="text-[12px] mt-8">
      ...
      <div className=" max-w-[1440px]  m-auto mt-8 gap-12 flex justify-center item-center grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 ">
        ...
        <div>
          <BsBrowserSafari className="text-blue-900" size={70} />
          <p className="text-3xl mt-7 ">Refractive surgery</p>
          <p className="text-[12px] mt-8">
            Distinctively re-engineer revolutionary meta-services and premium
            architectures. Intrinsically incubate intuitive opportunities and
        ...
        <div>
          <GiBlindfold className="text-blue-900" size={80} />
          <p className="text-3xl mt-5 ">Cornea</p>
          <p className="text-[12px] mt-8">
            Credibly innovate granular internal or “organic” sources whereas
            high standards in web-readiness. Energistically scale future-proof
      ...
      <div className=" max-w-[1440px] mb-24  m-auto mt-8 gap-12 flex justify-center item-center grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 ">
        <div>
          <BsBrowserSafari className="text-blue-900" size={80} />
          <p className="text-3xl mt-5 ">Lasik</p>
          <p className="text-[12px] mt-8">
            Dynamically target high-payoff intellectual capital for customized
            technologies. Objectively integrate emerging core competencies
        ...
        <div>
          <BsEmojiLaughing className="text-blue-900" size={70} />
          <p className="text-3xl mt-7 ">Refractive surgery</p>
          <p className="text-[12px] mt-8">
            Distinctively re-engineer revolutionary meta-services and premium
            architectures. Intrinsically incubate intuitive opportunities and
        ...
        <div>
          <BsGiftFill className="text-blue-900" size={80} />
          <p className="text-3xl mt-5 ">Cornea</p>
          <p className="text-[12px] mt-8">
            Credibly innovate granular internal or “organic” sources whereas
            high standards in web-readiness. Energistically scale future-proof
