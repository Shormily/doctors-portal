...
const Banner1 = () => {
  return (
    <>
      ...
      <div className="grid sm:grid-cols-1 lg:grid-cols-3  gap-24 justify-center items-center mt-16  max-w-[1240px] m-auto w-full">
        ...
        <p className="text-2xl  ">
          ...
          <p className=" mt-2 text-[12px] font-normal">
            If you wich to book an appointment with Medicare, please choose any
            of the days shown below, and bok with the desirec optometryst.
          </p>
          <div
            style={{
              justifyContent: "center",
      ...
      <div className="grid  sm:grid-cols-1 lg:grid-cols-3 gap-24 mt-12 justify-center items-center  max-w-[1240px] m-auto w-full">
        <p>
      ...
      <div className="grid pb-24 lg:grid-cols-3  sm:grid-cols-1 gap-24 mt-12 justify-center items-center  max-w-[1240px] m-auto w-full">
        <p>
       ...
       <button className="bg-[#1e3a8a] hover:bg-[#1e40af] border-none text-white btn-md    border border-blue-700 rounded-[3px] font-semibold ">
           View more of our service
            </button> 
