...
const Dashboard = () => {
  ...
  const menus = [
    ...
    // { name: "AllUsers", link: "/dashboard/allusers", icon: FiFolder },
    // { name: "AddDoctors", link: "/dashboard/addoctors", icon: FiFolder },
  ...
  return (
    <>
      <section className="flex gap-6 sidebar h-full">
        ...
        <div className="m-3 text-xl text-gray-900 w-full  font-semibold">
          <Outlet></Outlet>
        </div>
      </section>
